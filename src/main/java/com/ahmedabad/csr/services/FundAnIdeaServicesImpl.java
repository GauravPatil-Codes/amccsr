...
public class FundAnIdeaServicesImpl implements FundAnIdeaServices {
    ...
    private String createEmailBody(FundAnIdea fundAnIdea) {
        ...
        return "<!DOCTYPE html>" +
                ...
                "    .project-details { background: #f8f9fa; border-radius: 10px; padding: 20px; margin: 25px 0; border-left: 5px solid #007bff; }"
                +
                "    .project-details h3 { color: #007bff; font-size: 18px; margin-bottom: 15px; display: flex; align-items: center; }"
                +
                ...
                "    .info-value { color: #007bff; font-weight: 500; }" +
                "    .token-container { background: linear-gradient(135deg, #007bff 0%, #4dabf7 100%); border-radius: 12px; padding: 25px; margin: 30px 0; text-align: center; position: relative; overflow: hidden; }"
                +
                ...
                "    .instructions { background: #e3f2fd; border-left: 4px solid #007bff; padding: 20px; margin: 25px 0; border-radius: 0 8px 8px 0; }"
                +
                "    .instructions h3 { color: #007bff; font-size: 18px; margin-bottom: 10px; }" +
                ...
                +
                "    .application-id { background: #e3f2fd; padding: 12px; border-radius: 6px; margin: 15px 0; text-align: center; border: 1px solid #007bff; }"
                +
                "    .application-id strong { color: #007bff; }" +
                "    .fund-badge { background: linear-gradient(135deg, #007bff 0%, #0d6efd 100%); color: #ffffff; padding: 8px 16px; border-radius: 20px; font-size: 14px; font-weight: 600; display: inline-block; margin-bottom: 15px; }"
                +
